...
## Purpose
Enforces role-based authorization for administrative user operations and enables forceful user account deletion bypassing active order constraints with domain event broadcasting.
