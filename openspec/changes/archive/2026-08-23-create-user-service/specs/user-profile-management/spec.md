...
- **THEN** the system returns HTTP 200 OK with the user profile JSON containing userId, ullName, phoneNumber, vatarUrl, io, ddress, gender, dateOfBirth, and timestamp fields.
...
- **WHEN** an authenticated user submits a valid JSON payload to PUT /api/v1/users/profile with updated fields
...
- **WHEN** a user includes HTML or script tags within the io or ddress fields in PUT /api/v1/users/profile
